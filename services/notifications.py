...
class SendsMessages(Protocol):
    ...
    async def send_photo(self, chat_id: int, photo: str, caption: str | None = None, reply_markup: Any = None) -> None: ...
    async def send_video(self, chat_id: int, video: str, caption: str | None = None, reply_markup: Any = None) -> None: ...
    async def send_document(self, chat_id: int, document: str, caption: str | None = None, reply_markup: Any = None) -> None: ...
